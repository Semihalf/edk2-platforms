  ...
  )
{
   ...
   * the CP2 PCIE configuration must be performed after the
...
MV_PCIE_CONTROLLER mPcieController[] = {
  ...
  { /* CP2 PCIE0 @0xF6600000 */
    ...
    .ConfigSpaceAddress    = 0xE8000000,
    .HaveResetGpio         = FALSE,
    .PcieResetGpio         = { 0 },
    .PcieBusMin            = 0,
    .PcieBusMax            = 0xE,
    .PcieIoTranslation     = 0xE8F00000,
    .PcieIoWinBase         = 0x0,
    .PcieIoWinSize         = 0x10000,
    .PcieMmio32Translation = 0,
    .PcieMmio32WinBase     = 0xE9000000,
    .PcieMmio32WinSize     = 0x1000000,
    .PcieMmio64Translation = 0,
  ...
  { /* CP2 PCIE1 @0xF6620000 */
    ...
    .ConfigSpaceAddress    = 0xEA000000,
    .HaveResetGpio         = FALSE,
    .PcieResetGpio         = { 0 },
    .PcieBusMin            = 0,
    .PcieBusMax            = 0xE,
    .PcieIoTranslation     = 0xEAF00000,
    .PcieIoWinBase         = 0x0,
    .PcieIoWinSize         = 0x10000,
    .PcieMmio32Translation = 0,
    .PcieMmio32WinBase     = 0xEB000000,
    .PcieMmio32WinSize     = 0x1000000,
    .PcieMmio64Translation = 0,
  ...
  { /* CP2 PCIE2 @0xF6640000 */
    ...
    .ConfigSpaceAddress    = 0xEC000000,
    .HaveResetGpio         = FALSE,
    .PcieResetGpio         = { 0 },
    .PcieBusMin            = 0,
    .PcieBusMax            = 0xE,
    .PcieIoTranslation     = 0xECF00000,
    .PcieIoWinBase         = 0x0,
    .PcieIoWinSize         = 0x10000,
    .PcieMmio32Translation = 0,
    .PcieMmio32WinBase     = 0xED000000,
    .PcieMmio32WinSize     = 0x1000000,
    .PcieMmio64Translation = 0,

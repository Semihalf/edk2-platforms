...
/**
  ...
  @param[in]  Hour    The hour value to be encoded.
  @param[in]  Minute  The minute value to be encoded.
  @param[in]  Second  The second value to be encoded.
...
/**
  ...
  @param[in]  Year   The year value to be encoded.
  @param[in]  Month  The month value to be encoded.
  @param[in]  Day    The day value to be encoded.

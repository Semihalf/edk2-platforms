...
/**
  ...
  @param[in]  This                The pointer to the LoadPe32Image protocol instance
  @param[in]  ParentImageHandle   The caller's image handle.
  @param[in]  FilePath            The specific file path from which the image is loaded.
  @param[in]  SourceBuffer        If not NULL, a pointer to the memory location containing a copy of
                                  the image to be loaded.
  @param[in]  SourceSize          The size in bytes of SourceBuffer.
  @param[in]  DstBuffer           The buffer to store the image.
  @param[in]  NumberOfPages       For input, specifies the space size of the image by caller if not NULL.
                                  For output, specifies the actual space size needed.
  @param[in]  ImageHandle         The image handle for output.
  @param[in]  EntryPoint          The image entry point for output.
  @param[in]  Attribute           The bit mask of attributes to set for the load PE image.
...
/**
  ...
  @param[in]  This              The pointer to the LoadPe32Image protocol instance
  @param[in]  ImageHandle       The specified image handle to be unloaded.

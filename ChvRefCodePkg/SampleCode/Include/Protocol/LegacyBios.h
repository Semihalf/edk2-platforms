...
/**
  ...
  @retval FALSE          Thunk completed with no BIOS errors in the target code. See Regs for status.
...
/**
  ...
  @retval EFI_DEVICE_ERROR    Failed to boot from any boot device and memory is uncorrupted.
                              Note: This function normally does not returns. It will either boot the
